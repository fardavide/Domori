...
struct WorkspaceDetailView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .confirmationDialog("Delete Workspace", isPresented: $showingDeleteConfirmation) {
                Button("Delete", role: .destructive) {
                    deleteWorkspace()
                }
                Button("Cancel", role: .cancel) { }
            } message: {
                Text("Are you sure you want to delete this workspace? This action cannot be undone and all members will lose access.")
            }
        }
    }
...
#Preview {
    ...
    return WorkspaceDetailView(workspace: sampleWorkspace)
